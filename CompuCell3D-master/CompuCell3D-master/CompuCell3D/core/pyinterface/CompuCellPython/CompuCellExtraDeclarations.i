...
//FieldManager_autogenerated1
#define FIELDMANAGER_EXPORT
//VectorFieldPolarization_autogenerated1
...
//FieldManager_autogenerated2


%include <CompuCell3D/steppables/FieldManager/FieldManager.h>

%inline %{

 FieldManager * getFieldManager(){

      return (FieldManager *)Simulator::steppableManager.get("FieldManager");

   }

%}

//VectorFieldPolarization_autogenerated2


%include <CompuCell3D/plugins/VectorFieldPolarization/VectorFieldPolarizationPlugin.h>



%inline %{

 VectorFieldPolarizationPlugin * getVectorFieldPolarizationPlugin(){

      return (VectorFieldPolarizationPlugin *)Simulator::pluginManager.get("VectorFieldPolarization");
